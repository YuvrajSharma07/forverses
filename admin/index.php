...
<body>
    ...
    <header>
        ...
        <button class="btn btn-sm btn-danger" type="button" id="logOut_user"><i class="fa fa-power-off"></i> Log out</button>
    </header>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group" id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" id="events_tab" data-toggle="list" href="#events" role="tab">Edit Events</a>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="submissions" role="tabpanel" aria-labelledby="submissions_tab">
                        <div class="container p-5">
                            ...
                            <div class="btn-group" role="group" id="submissions_sort">
                    ...
                    <div class="tab-pane fade" id="events" role="tabpanel" aria-labelledby="events_tab">
                        <div class="container p-5">
                            <h1>Your Events</h1>
                            <button type="button" class="btn btn-outline-dark my-3" id="add_event"><i class="fa fa-plus"></i> Add</button>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                    ...
                    <div class="tab-pane fade" id="journal" role="tabpanel" aria-labelledby="journal_tab">
                        <div class="container p-5">
                            ...
                            <div class="btn-group" role="group" id="journal_editor">
                                <button type="button" class="btn btn-outline-dark">Colours</button>
                    ...
                    <div class="tab-pane fade" id="collabs" role="tabpanel" aria-labelledby="collabs_tab">
                        <div class="container p-5">
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-outline-primary" id="add_collab"><i class="fa fa-plus"></i> Add</button>
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="current_collabs"></tbody>
                            </table>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="web" role="tabpanel" aria-labelledby="web_tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="web_assets" role="tabpanel" aria-labelledby="webassets">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-outline-primary"><i class="fa fa-font"></i> Fonts</button>
                                    <button type="button" class="btn btn-outline-primary"><i class="fa fa-image"></i> Images</button>
                                    <button type="button" class="btn btn-outline-primary"><i class="fa fa-css3"></i> Custom CSS</button>
                                </div>
                                <div id="web_assets_items"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <form class="w-50 text-center" enctype="multipart/form-data" method="post">
            ...
            <button class="btn btn-primary" type="submit" value="submit" name="submit">Go!</button>
        </form>
    </div>
    <?php
    }
